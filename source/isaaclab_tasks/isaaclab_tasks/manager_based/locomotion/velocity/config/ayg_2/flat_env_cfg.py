...
import isaaclab_tasks.manager_based.locomotion.velocity.config.ayg_2.mdp as ayg_mdp
...
class AygTerminationsCfg:
    ...
    body_contact = DoneTerm(
        ...
        params={"sensor_cfg": SceneEntityCfg("contact_forces", body_names=["Base", ".*_Shank"]), "threshold": 1.0},
    )
...
@configclass
class Ayg2FlatEnvCfg(LocomotionVelocityRoughEnvCfg):
...
class Ayg2FlatEnvCfg_PLAY(Ayg2FlatEnvCfg):
